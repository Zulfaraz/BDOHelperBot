...
class BDOHelperBotInformationJSONClass {
  private BDOHelperBotData: any = null;
  private BDOHelperBotDataQuery: any = null;
  BDOHelperBotBuilderMessegeAlertLog(BDMHelperBotQuerry: string) {
    const BDOHBDivederR: any = "┇-------------------------";
    const BDOHBDivederL: any = "-------------------------┇";
    ...
    const DATAFILTER = this.BDOHelperBotData.filter(
      (DATAKEY: any) => DATAKEY.BDOMsgName === DATAQUERY,
      Boolean,
    );
    return DATAFILTER;
  }
  BDOHelperBotBuilderMessegeEmbed(BDMHelperBotQuerry: string) {
    this.BDOHelperBotDataQuery = BDMHelperBotQuerry;
    this.BDOHelperBotData = [
      {
...
export default BDOHelperBotInformationJSONClass;
